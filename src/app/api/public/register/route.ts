    ...
    return NextResponse.json(
      {
        ...
        data: {
          ...
          full_name: fullName,
          address: cricketer.address,
          contact_number_1: cricketer.contact_number_1,
          contact_number_2: cricketer.contact_number_2 || "",
          age: cricketer.age,
          cricket_categories: cricketer.cricket_categories,
          capacity_roles: cricketer.capacity_roles,
          jersey_size: cricketer.jersey_size,
          jersey_number: cricketer.jersey_number,
          jersey_name: cricketer.jersey_name,
